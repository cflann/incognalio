...
document.body.onmouseup = function(e) {
  ...
  var a = React.render(React.createElement(Anchor, {inner: __html}), wrapper);
  rangy.getSelection(wrapper);
  
};


},{"./components/Anchor.jsx":159,"rangy":3,"react":158}],2:[function(require,module,exports){
...
var Anchor = React.createClass({displayName: "Anchor",
  ...
  render: function() {
    ...
    return (
      React.createElement("span", {className: classString, onClick: this.toggleHighlight, dangerouslySetInnerHTML: this.props.inner})
    );
  }
